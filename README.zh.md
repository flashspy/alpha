...
### v1.0.0 (最新版本) - 生产版本发布 - 完整功能集
**发布日期**: 2026-02-01

**重大里程碑**: 128/128 需求 (100% 完成)，99.7% 测试通过率，生产就绪

详细发布说明请查看 [RELEASE_NOTES_v1.0.0.md](RELEASE_NOTES_v1.0.0.md)

### v0.10.1 - 客户端-服务器架构与WebSocket API
**发布日期**: 2026-02-01

**新功能:**
- 🌐 **WebSocket实时API** - 通过WebSocket协议实现低延迟流式聊天
- 🔄 **客户端-服务器架构** - 真正的后台服务器与CLI客户端
- 🛠️ **修复命令一致性** - 统一PID文件管理
...
**当前版本**: v1.0.0
**状态**: 生产就绪 ✅
**最新功能**: Alpha v1.0.0 完整功能集 - 128/128 需求完成，99.7%测试通过率
